  ...
  return (
    <div className="page-background">
      ...
      <div className="freelanceWhiteSection">
        ...
        <p>Other subjects available on request</p>
      </div>
      ...
      <div className="freelanceDarkSection">
        <h3>Prices</h3>
        <p>£20 per person per hour for Small Group</p>
        <p>£25 per hour 1-1 Remote</p>
        <p>£30 per hour 1-1 Face-to-Face</p>
        <p>£30 per hour for tutoring at my home</p>
        <p>
